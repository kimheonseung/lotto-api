...
public class PagingVO {
    ...
    public static PagingVO build(SearchParameterVO searchParameterVO, long total) {

        final int page      = searchParameterVO.getPage();
        final int size      = searchParameterVO.getSize();
        final int rows      = searchParameterVO.getRows();
